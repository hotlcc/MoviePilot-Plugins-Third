...
class DownloaderHelper(_PluginBase):
    ...
    def __get_dashboard_active_torrent_widget(self, downloader_name: str) -> Optional[Tuple[Dict[str, Any], Dict[str, Any], List[dict]]]:
        ...
        # 页面元素
        elements = self.__get_dashboard_active_torrent_widget_elements(service_info=service_info)
    ...
    def __get_dashboard_speed_widget(self, downloader_name: str) -> Optional[Tuple[Dict[str, Any], Dict[str, Any], List[dict]]]:
        ...
        # 页面元素
        elements = self.__get_dashboard_speed_widget_elements(service_info=service_info)
    ...
    def __get_dashboard_active_torrent_widget_elements(self, service_info: ServiceInfo) -> list:
        """
        获取仪表板活动种子组件元素
        """
        if not service_info:
    ...
    def __get_dashboard_speed_widget_elements(self, service_info: ServiceInfo) -> list:
        """
        获取仪表板实时速率组件元素
        """
        if not service_info:
